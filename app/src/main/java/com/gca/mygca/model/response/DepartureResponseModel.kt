...
val image:String,val timestamp:String?,val branch_id:String?,val mobileNo:String,val inChargeName:String,val date:String,val time:String,val vehicle_no:String)